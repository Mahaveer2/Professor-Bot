...
<nav class={`nav flex flex-wrap items-center justify-between px-4`}>
  ...
  <ul class="md:relative absolute top-[7%] left-0 w-full md:bg-opacity-0 bg-black bg-opacity-5 backdrop-blur-lg transition menu border-b md:border-none flex justify-end list-reset m-0 w-full md:w-auto">
